...
export class DiceFactory {
	...
	constructor() {
		...
		this.systems = {
			...
			'dot_d': {id: 'dot_d', name: game.i18n.localize("Degenesis"), dice:[]}
		};
		let diceobj;
		...
		diceobj.name = 'd6';
		diceobj.setLabels([
			'worlds/degenesis-world/style/dices-faces/d1c.png',
			'worlds/degenesis-world/style/dices-faces/d2c.png',
			'worlds/degenesis-world/style/dices-faces/d3c.png',
			'worlds/degenesis-world/style/dices-faces/d4c.png',
			'worlds/degenesis-world/style/dices-faces/d5c.png',
			'worlds/degenesis-world/style/dices-faces/d6c.png',
		]);
		diceobj.setBumpMaps([
			'worlds/degenesis-world/style/dices-faces/d1c_bump.png',
			'worlds/degenesis-world/style/dices-faces/d2c_bump.png',
			'worlds/degenesis-world/style/dices-faces/d3c_bump.png',
			'worlds/degenesis-world/style/dices-faces/d4c_bump.png',
			'worlds/degenesis-world/style/dices-faces/d5c_bump.png',
			'worlds/degenesis-world/style/dices-faces/d6c_bump.png',
		]);
		diceobj.setValues(1,6);
		diceobj.scale = 0.9;
		diceobj.system = "dot_d";
		this.register(diceobj);
	}
